...
@OpenAPIDefinition(
        info = @Info(
                title = "API Marketing de Crescimento",
                version = "2.0.0",
                description = "API RESTful desenvolvida para gestão de campanhas de tráfego pago, contas de anunciantes e análise de métricas diárias.",
                contact = @Contact(
                        name = "Wesley Miguel",
